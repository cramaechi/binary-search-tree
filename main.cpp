...
int main()
{
   ...
   char listOfNumbers[25];
   cout<<"\nEnter a list of 10 nonnegative integers, and press Return.\n";
   cin.getline(listOfNumbers, 25);
   ...
   do
   {
      ...
      cout<<"\n\nWould you like to remove a number from the tree? (y/n): ";
      cin>>ans;
